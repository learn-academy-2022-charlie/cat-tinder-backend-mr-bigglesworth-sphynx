...
RSpec.describe "Dinos", type: :request do
  ...
  describe "PATCH /update" do
    ...
    it 'does not update a dino without a name' do
      ...
      # I need to make a request to my application to update the object we made
      updated_dino = Dino.find(dino.id)
      patch "/dinos/#{testId}", params: updated_dino_params
      # I need to assert that the response is correct
        # status code
        p dino
      expect(response).to have_http_status(200)
      ...
      expect(updated_dino[:name]).to include "can't be blank"
  end

#   it 'does not update a dino without an age' do
...
#   it 'does not update a dino without an enjoys' do
...
#     # I need to make a request to my appilcation to update the object we made
#     post '/dinos', params: dino_params
#     # I need to assert that the response is correct
#       # status code
#     expect(response).to have_http_status(422)
...
#   it 'does not update a dino without an image' do
